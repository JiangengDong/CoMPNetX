...
#ifndef COMPNETX_MPNETWITHOUTTSRSAMPLER_H
#define COMPNETX_MPNETWITHOUTTSRSAMPLER_H
...
namespace CoMPNetX {
class MPNetWithoutTSRSampler : public MPNetSampler {
public:
    typedef std::shared_ptr<MPNetWithoutTSRSampler> Ptr;
    MPNetWithoutTSRSampler(const ompl::base::StateSpace *space,
...
private:
    ...
    unsigned int space_dim_; // dimension of config
    unsigned int pnet_dim_;
...
#endif //COMPNETX_MPNETWITHOUTTSRSAMPLER_H
